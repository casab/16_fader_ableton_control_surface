...
class MiSW_XVI(ControlSurface):   # Make sure you update the name
    __doc__ = " Script for MiSW_XVI in APC emulation mode "   # Make sure you update the name
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in MiSW_XVI._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in MiSW_XVI._active_instances:    # Make sure you update the name
            MiSW_XVI._active_instances.append(self)   # Make sure you update the name
            MiSW_XVI._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        if (self in MiSW_XVI._active_instances) and MiSW_XVI._active_instances.remove(self):    # Make sure you update the name
